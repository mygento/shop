...
class Webshopapps_Matrixrate_Model_Mysql4_Carrier_Matrixrate extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    public function getNewRate(Mage_Shipping_Model_Rate_Request $request,$zipRangeSet=0)
    {
      ...
      $newdata = $iteamoDelinDeliveryCalculator->init($arMagentoDeliveryMethods = $newdata, $objRequest = $request);      
      iteamoDelinDeliveryCalculator::log($newdata, '$newData', $file = __FILE__);
    // >>> ITEAMO . DELIN DELIVERY CALCULATOR
